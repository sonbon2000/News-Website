...
$id = $_GET['id'];
$url = "http://localhost/IWS-Final/webservices/api/get_all_news_by_tags.php?id=$id&&page=$page";
        ...
        <div class="case">
            <div class="row">
                <div class="col-md-6 col-lg-6 col-xl-6 d-flex">
                    <a href='news_single.php?id=<?php echo $value['news_id']; ?>' class="img w-100 mb-3 mb-md-0" style="background-image: url('images/news-pics/<?php echo $value['pic']; ?>.jpg');">
                    </a>
                </div>
                <div class="col-md-6 col-lg-6 col-xl-6 d-flex">
